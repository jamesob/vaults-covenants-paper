...
Currently there is no way to enforce covenants ``on-chain,'' but there are many
pending proposals for how to modify Bitcoin's validation rules to allow for this
functionality. Covenant proposals can be divided into two kinds:
...
limited-covenant approaches in which the allowed graph of transactions must be
